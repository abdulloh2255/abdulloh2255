...
function Navbar() {
  ...
  const API = `https://api.kinopoisk.dev/v1.4/movie/search?query=${searchText}&token=N0HRC6K-07PM9FV-MSRZGFP-T8M7QDF`;
  ...
  return (
    <div>
      <div className="navbar bg-base-100 dark:bg-slate-500 dark:text-red-50 align-element">
        ...
        <div className="flex-none gap-6">
          ...
          <li className="list-none">
            <Link className="text-xl font-medium text-white" to="/login">
              LogIn
            </Link>
          </li>
          <li className="list-none">
            <Link className="text-xl font-medium text-white" to="/signUp">
              Singup
            </Link>
          </li>
